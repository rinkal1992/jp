...
class calculate_ActualRate_INR extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'calculate_ActualRate_INR';
    ...
    {
        $builder = DB::table("transaction_inr");
        $builder->select('*');
...
//                    rount($item->amount / $Data[2], 2);
                    $ConversionInfo['actual_rate'] = round($item->amount / $Data[2], 2);
                }
