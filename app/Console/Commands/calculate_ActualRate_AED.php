...
class calculate_ActualRate_AED extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'calculate_ActualRate_AED';
    ...
    {
        $builder = DB::table("transaction_aed");
        $builder->select('*');
